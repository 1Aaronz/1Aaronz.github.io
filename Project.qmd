...
```{r}
Stock_data <- read.csv("C:/Users/aaron/Documents/data analitics/Dataproject/1Aaronz/data.csv")
head(Stock_data)
```
...
```{r}
stocks <- read_csv("C:/Users/aaron/Documents/data analitics/Dataproject/1Aaronz/data.csv")
