...
Regular season performance data and bracket structure data was sourced from Kaggle

Advanced efficiency metrics was sourced from Kenpom

Public picks data: Pulled from the mRchmadness package, which scrapes pick data from ESPN
