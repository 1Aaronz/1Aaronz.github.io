...
This project visualizes Global High Speed Rail (HSR) progress compared to the US. It emphasizes the difference in the length of HSR other countries have managed to achieve while the US continues to have slow progress in HSR construction. This project will compare both historical HSR lengths and visualize the change up to the present day and 10 years into the future.
...
China appears as a big outlier in total HSR kilometers. The US is only seen much further down the list, and almost all countries that have any HSR are ahead of the US. 
...
The discrepancy between the front runner and the US grew a significant amount between 2000 and 2026. While the front runner had 31x more HSR than the US in 2000, in 2026 china, the current front runner, has 245x more HSR than the US.  
